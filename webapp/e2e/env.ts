...
export const composeProjectName =
  process.env.COMPOSE_PROJECT_NAME ?? `poznyak-engineering-calculator-${repositoryHash}`
...
export const defaultDatabaseUrl = `postgresql://superuser:superpassword@localhost:${defaultPostgresTestPort}/poznyak_engineering_calculator_test?schema=public`
