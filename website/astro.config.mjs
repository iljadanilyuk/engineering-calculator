...
// landing/calculator shell, project examples, FAQ, and contact pages.
//
// SSR/hybrid is not the default. Use rebuild/redeploy for durable content
// changes first. Cached on-demand/SSR routes and server islands for
...
// rendering, e.g. token-protected proposal views or request-specific pages
