...
export const curatedProjectCases = [
  {
    ...
    description:
      'Санитизированный пример комплекта, где проект заранее связывает котельную, трассы отопления, вентиляцию и спецификации для закупки.',
    ...
    fragments: [
      {
        ...
        imageAlt: 'Санитизированный лист проекта с планами трасс инженерных систем',
      },
      {
        ...
        imageAlt: 'Санитизированный лист проекта с 3D-фрагментом котельной',
      },
      {
        ...
        imageAlt: 'Санитизированный лист проекта со спецификацией оборудования',
      },
    ],
    exampleSlugs: ['ov'],
    seoTitle: 'Кейс проекта отопления и вентиляции дома | ИП Позняк',
    seoDescription:
      'Реализованный проект отопления и вентиляции частного дома: задача, разделы инженерии, фрагменты документации и gated получение PDF-примера.',
  },
  {
    ...
    solutionSummary:
      'Показанные листы фиксируют трассировку и детали подключения, а полный пример выдается только после контакта через Telegram или token-ссылку.',
    ...
    fragments: [
      {
        ...
        imageAlt: 'Санитизированный лист проекта ВК с узлом подключения',
      },
      {
        title: 'План разводки',
        caption:
        ...
        imageUrl: '/landing-v4/project-preview-plan-08.jpg',
        imageAlt: 'Санитизированный план разводки инженерных систем',
      },
      {
        ...
        imageUrl: '/landing-v4/project-preview-spec-10.jpg',
        imageAlt: 'Санитизированная ведомость материалов проекта',
      },
    ],
    exampleSlugs: ['vk'],
    seoTitle: 'Кейс проекта ВК коттеджа | ИП Позняк',
    seoDescription:
      'Реализованный проект водоснабжения и канализации: задача, площадь, инженерные разделы, фрагменты документации и защищенная выдача PDF-примера.',
  },
...
function managedRecordToProjectCase(record: PublicProjectExampleRecord): ProjectCase {
  ...
  return {
    ...
    solutionSummary: record.solutionSummary ?? 'Полный комплект выдается после контакта через Telegram или token-ссылку.',
    coverImageUrl,
