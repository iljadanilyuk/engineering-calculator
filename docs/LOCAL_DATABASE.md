...
docker compose exec postgres pg_isready -U superuser -d poznyak_engineering_calculator
```
...
host: localhost
port: 54329
database: poznyak_engineering_calculator
user: superuser
password: superpassword
DATABASE_URL: postgresql://superuser:superpassword@localhost:54329/poznyak_engineering_calculator?schema=public
```
...
host: localhost
port: 54330
database: poznyak_engineering_calculator_test
user: superuser
password: superpassword
